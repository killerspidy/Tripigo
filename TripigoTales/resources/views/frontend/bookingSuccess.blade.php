...
<div class="print-only text-center mb-4">
    <img src="{{ asset('images/logo.png') }}" alt="Tripigo Tales" style="height: 60px;">
                ...
                <div class="breadcrumb-content text-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('frontend.tour') }}">Tours</a></li>
                        ...
                        <div class="booking-box">
                            ...
                            <div class="booking-box-title d-md-flex align-items-center bg-title p-4 mb-4 rounded text-md-start text-center">
                                ...
                                <div class="title-content ms-md-3">
                                    ...
                                    <p class="mb-0 white">A confirmation has been sent to <strong>{{ $user->email ?? 'your email address' }}</strong>.</p>
                                </div>
                            </div>
                            ...
                            <div class="travellers-info mb-4">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="theme2">#{{ $booking->id }}</td>
                                            <td class="theme2">{{ $booking->created_at->format('d M Y, h:i A') }}</td>
                                            <td class="theme2">₹{{ number_format($booking->total_amount, 2) }}</td>
                            ...
                            <div class="travellers-info mb-4">
                                ...
                                <table>
                                    <tr>
                                        <td>Tour</td>
                                        <td><a href="{{ route('frontend.tour.detail', $tour->slug) }}" class="theme">{{ $tour->title }}</a></td>
                                    </tr>
                                    @if($tour->location)
                                    <tr>
                                        <td>Location</td>
                                    ...
                                    <tr>
                                        <td>Duration</td>
                                        <td>{{ $booking->days ? $booking->days . ' ' . Str::plural('Day', $booking->days) : 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <td>No. of Persons</td>
                            ...
                            <div class="booking-border mb-4">
                                ...
                                <table class="w-100">
                                    <tr>
                                        <td>Status</td>
                                        <td><span class="badge bg-success text-white px-3 py-1">{{ ucfirst($booking->status) }}</span></td>
                                    </tr>
                                    <tr>
                                        <td>Payment ID</td>
                                        <td><code>{{ $booking->razorpay_payment_id }}</code></td>
                                    </tr>
                                    <tr>
                                        <td>Order ID</td>
                                        <td><code>{{ $booking->razorpay_order_id }}</code></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="booking-border d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('frontend.tour.detail', $tour->slug) }}" class="nir-btn-black"><i class="fa fa-eye"></i> View Tour</a>
                                <a href="{{ route('frontend.tour') }}" class="nir-btn-black"><i class="fa fa-search"></i> Explore More Tours</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sidebar-sticky">
                        <div class="list-sidebar">
                            ...
                            <div class="sidebar-item bordernone bg-white rounded box-shadow overflow-hidden mb-4">
                                @if($tour->image)
                                    <img src="{{ asset($tour->image) }}" alt="{{ $tour->title }}" class="w-100" style="height: 200px; object-fit: cover;">
                                @endif
                                <div class="p-3">
                                    <h5 class="mb-1"><a href="{{ route('frontend.tour.detail', $tour->slug) }}">{{ $tour->title }}</a></h5>
                                    @if($tour->location)
                                        <p class="mb-1 theme"><i class="icon-location-pin"></i> {{ $tour->location }}</p>
                                    @endif
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        <span><i class="fa fa-calendar"></i> {{ $booking->days ? $booking->days . ' ' . Str::plural('Day', $booking->days) : 'N/A' }}</span>
                                        <span><i class="fa fa-users"></i> {{ $booking->persons }} {{ Str::plural('Person', $booking->persons) }}</span>
                                    </div>
                                    <div class="mt-2 pt-2 border-top">
                                        <h5 class="theme mb-0">₹{{ number_format($booking->total_amount, 2) }} <small class="text-muted">Paid</small></h5>
                                    </div>
                                </div>
                            </div>
