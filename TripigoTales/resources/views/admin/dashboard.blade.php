                        ...
                        <div class="d-flex align-items-center">
                            <div class="m-r-25">
                                <div class="position-relative">
                                    <img src="{{ asset('images/user-avatar.jpg') }}" alt="user" width="80" height="80" class="rounded-circle user-avatar-mobile" style="object-fit: cover; border: 4px solid #f1f1f1;" />
                            ...
                            <div>
                                <h2 class="m-b-5 font-bold">Welcome back, {{ auth()->user()->name }}!</h2>
                                <p class="text-muted m-b-0"><i class="ti-calendar m-r-5"></i> {{ date('l, d F Y') }}</p>
                            </div>
                            <div class="ml-auto d-none d-lg-block">
                                <a href="{{ route('logout') }}" class="btn btn-outline-danger btn-rounded px-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <h6 class="text-white opacity-7">{{ date('F Y') }}</h6>
                            </div>
                            <div class="ml-auto">
