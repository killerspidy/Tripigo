                    ...
                    <form method="POST" action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="client_name" class="form-control" placeholder="e.g. Jared Erondu" value="{{ old('client_name') }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Client Title / Position</label>
                                <input type="text" name="client_title" class="form-control" placeholder="e.g. Supervisor" value="{{ old('client_title') }}">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Testimonial Content <span class="text-danger">*</span></label>
                                <textarea name="content" class="form-control" rows="5" placeholder="The review or quote from the client" required>{{ old('content') }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Client Image</label>
                                <input type="file" name="image" class="form-control" accept="image/*">
                                <small class="text-muted">JPG, PNG, WebP. Max 2MB. Optional.</small>
                            </div>
