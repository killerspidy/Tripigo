 <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin1" style="display: flex !important; flex-direction: row !important; align-items: center !important; flex-wrap: nowrap !important;">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.dashboard') }}" style="flex: 1; min-width: 0;">
                        <b class="logo-icon flex-shrink-0">
                            <img src="{{ asset('images/favicon.png') }}" alt="homepage" class="dark-logo" style="height: 35px !important; width: auto !important; max-width: 35px;" />
                        </b>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="m-r-10 d-none d-md-block text-muted font-medium">{{ auth()->user()->name }}</span>
                                    <img src="{{ asset('images/user-avatar.jpg') }}" alt="user" class="rounded-circle" width="35" height="35" style="object-fit: cover; border: 2px solid #eee;">
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY" style="border-radius: 12px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10" style="border-radius: 12px 12px 0 0;">
                                    <div class="m-r-10">
                                        <img src="{{ asset('images/user-avatar.jpg') }}" alt="user" class="img-circle" width="60" height="60" style="object-fit: cover; border: 2px solid rgba(255,255,255,0.2);">
                                    </div>
                                    <div class="m-l-10">
                                        <h4 class="m-b-0 text-white">{{ auth()->user()->name }}</h4>
                                        <p class=" m-b-0 opacity-7 text-white" style="font-size: 0.85rem;">{{ auth()->user()->email }}</p>
                                    </div>
                                </div>
                                <a class="dropdown-item p-10" href="{{ route('logout') }}">
