...
<div class="container-fluid pb-5">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <small class="text-muted">Update the tour details below. All fields are optional.</small>
        </div>
    ...
    <form method="POST" action="{{ route('tours.update', $tour->slug) }}"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="language" class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}"
                               value="{{ old('language', $tour->language) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="subcategory" name="subcategory_id" class="form-control {{ $errors->has('subcategory_id') ? 'is-invalid' : '' }}">
                            @foreach($subcategories as $sub)
                                <option value="{{ $sub->id }}" {{ old('subcategory_id', $tour->subcategory_id) == $sub->id ? 'selected' : '' }}>
                                    {{ $sub->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="tour_duration" class="form-control {{ $errors->has('tour_duration') ? 'is-invalid' : '' }}"
                               value="{{ old('tour_duration', $tour->tour_duration) }}" placeholder="e.g. 3 Days / 2 Nights">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="star_rating" class="form-control {{ $errors->has('star_rating') ? 'is-invalid' : '' }}">
                            ...
                            @for($i = 1; $i <= 5; $i++)
                                <option value="{{ $i }}" {{ old('star_rating', $tour->star_rating) == $i ? 'selected' : '' }}>{{ $i }} ★</option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        @if(!empty($tour->image))
                            <div class="mt-2 d-flex align-items-center gap-2">
                                <img src="{{ asset($tour->image) }}" alt="Current" class="img-preview">
                    ...
                    <div class="col-md-4">
                        ...
                        @if(!empty($tour->gallery_images) && is_array($tour->gallery_images))
                            <div class="mt-2 d-flex flex-wrap gap-2">
                                @foreach($tour->gallery_images as $gimg)
                                    <img src="{{ asset($gimg) }}" alt="Gallery" class="img-preview">
                                @endforeach
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        @if(!empty($tour->pdf))
                            <small class="text-muted d-block mt-1">
                                📎 Current: <a href="{{ asset($tour->pdf) }}" target="_blank">{{ basename($tour->pdf) }}</a>
                            </small>
                        @endif
        ...
        <div class="card shadow-sm border-0 rounded-3 mb-4">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="special_discount" class="form-control {{ $errors->has('special_discount') ? 'is-invalid' : '' }}"
                                   value="{{ old('special_discount', $tour->special_discount ?? 0) }}" min="0" max="100">
                            <span class="input-group-text">%</span>
                        </div>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="status_discount" name="discount_status" value="1"
                                   {{ old('discount_status', $tour->discount_status) ? 'checked' : '' }}>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="min_age" class="form-control {{ $errors->has('min_age') ? 'is-invalid' : '' }}"
                               value="{{ old('min_age', $tour->min_age) }}" min="0" max="120">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="bedroom" class="form-control {{ $errors->has('bedroom') ? 'is-invalid' : '' }}"
                               value="{{ old('bedroom', $tour->bedroom) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="day" id="daysHidden" value="{{ $daysVal }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="what_to_expect" id="expectHidden" value="{{ $expectVal }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="price_includes" id="tagsValue" value="{{ $priceIncludes }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="departure_return_location" id="departureHidden" value="{{ $departures }}">
        ...
        <div class="card shadow-sm border-0 rounded-3 mb-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-3 mb-4">
                    <label class="sched-radio-card {{ $schedType === 'weekly' ? 'active' : '' }}" for="sched_weekly" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_weekly"
                               value="weekly" {{ $schedType === 'weekly' ? 'checked' : '' }}
                    ...
                    <label class="sched-radio-card {{ $schedType === 'specific' ? 'active' : '' }}" for="sched_specific" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_specific"
                               value="specific" {{ $schedType === 'specific' ? 'checked' : '' }}
                    ...
                    <label class="sched-radio-card {{ $schedType === 'open' ? 'active' : '' }}" for="sched_open" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_open"
                               value="open" {{ $schedType === 'open' ? 'checked' : '' }}
                ...
                <div id="sched_weekly_opts" class="schedule-opts mb-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-2">
                        @foreach($dayDefs as $idx => $info)
                            @php $isChecked = in_array($idx, (array)$schedDays); @endphp
                ...
                <div id="sched_specific_opts" class="schedule-opts mb-3" style="display:none;">
                    <label class="form-label">Enabled Dates</label>
                    ...
                    <input type="hidden" name="specific_dates" id="specific_dates_hidden" value="{{ $specDatesVal }}">
                ...
                <input type="hidden" name="available_dates" id="available_dates_hidden" value="{{ $blockedDatesVal }}">
                ...
                <div id="qaWrapper">
                    @forelse($plans as $i => $plan)
                        <div class="input-group mb-2">
                            <span class="input-group-text bg-light" style="min-width:70px; font-size:12px;">Day {{ $i + 1 }}</span>
                            <input type="text" name="question[]" class="form-control"
                                   value="{{ $plan['question'] ?? '' }}" placeholder="Day title">
                            <input type="text" name="answer[]" class="form-control"
                                   value="{{ $plan['answer'] ?? '' }}" placeholder="Description">
                            @if($i > 0)
...
$('#category').change(function () {
    ...
    $.get('/admin/get-subcategories/' + id, function (data) {
        ...
        const currentSub = '{{ old("subcategory_id", $tour->subcategory_id) }}';
        data.forEach(item => {
            $('#subcategory').append(
