                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="discount" class="form-control" placeholder="10" step="0.01" min="0" max="999999.99" value="{{ old('discount', $coupon->discount) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="min_amount" class="form-control" placeholder="0.00" step="0.01" min="0" value="{{ old('min_amount', $coupon->min_amount) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="usage_limit" class="form-control" placeholder="Unlimited" min="1" value="{{ old('usage_limit', $coupon->usage_limit) }}">
                                <small class="form-text text-muted">Maximum number of times this coupon can be used across all users. Currently used: {{ $coupon->used_count }} times.</small>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ old('status', $coupon->status) ? 'checked' : '' }}>
