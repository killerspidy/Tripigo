<?php $__env->startSection('title', 'Add New Tour'); ?>
...
<div class="container-fluid pb-5">
    ...
    <form method="POST" action="<?php echo e(route('tours.store')); ?>" enctype="multipart/form-data" onkeydown="return event.key !== 'Enter';">
        <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="title" class="form-control <?php echo e($errors->has('title') ? 'is-invalid' : ''); ?>"
                               placeholder="e.g. Manali Winter Trek" value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="location" class="form-control <?php echo e($errors->has('location') ? 'is-invalid' : ''); ?>"
                               placeholder="e.g. Manali, Himachal Pradesh" value="<?php echo e(old('location')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="language" class="form-control <?php echo e($errors->has('language') ? 'is-invalid' : ''); ?>"
                               placeholder="e.g. Hindi, English" value="<?php echo e(old('language')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="category" name="category_id" class="form-control <?php echo e($errors->has('category_id') ? 'is-invalid' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="subcategory" name="subcategory_id" class="form-control <?php echo e($errors->has('subcategory_id') ? 'is-invalid' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="tour_duration" class="form-control <?php echo e($errors->has('tour_duration') ? 'is-invalid' : ''); ?>"
                               placeholder="e.g. 3 Days / 2 Nights" value="<?php echo e(old('tour_duration')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="star_rating" class="form-control <?php echo e($errors->has('star_rating') ? 'is-invalid' : ''); ?>">
                            <option value="">Select</option>
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('star_rating') == $i ? 'selected' : ''); ?>><?php echo e($i); ?> ★</option>
                            <?php endfor; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="status" name="status" value="1" <?php echo e(old('status', 1) ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="price" class="form-control <?php echo e($errors->has('price') ? 'is-invalid' : ''); ?>"
                                   placeholder="e.g. 2999" value="<?php echo e(old('price')); ?>">
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="special_discount" class="form-control <?php echo e($errors->has('special_discount') ? 'is-invalid' : ''); ?>"
                                   value="<?php echo e(old('special_discount', 0)); ?>" min="0" max="100">
                            <span class="input-group-text">%</span>
                        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="max_people" class="form-control <?php echo e($errors->has('max_people') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('max_people')); ?>" min="1" placeholder="e.g. 15">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="min_age" class="form-control <?php echo e($errors->has('min_age') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('min_age')); ?>" min="0" max="120" placeholder="e.g. 10">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="bedroom" class="form-control <?php echo e($errors->has('bedroom') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('bedroom')); ?>" placeholder="e.g. Camping, Hotel">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pickup" class="form-control <?php echo e($errors->has('pickup') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('pickup')); ?>" placeholder="e.g. Bus from Delhi">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="day" id="daysHidden" value="<?php echo e(old('day')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="what_to_expect" id="expectHidden" value="<?php echo e(old('what_to_expect')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="price_includes" id="tagsValue" value="<?php echo e(old('price_includes')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="departure_return_location" id="departureHidden" value="<?php echo e(old('departure_return_location')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="4"
                                  ...
                                  placeholder="Detailed tour description…"><?php echo e(old('description')); ?></textarea>
        ...
        <div class="card shadow-sm border-0 rounded-3 mb-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-3 mb-4">
                    ...
                    <label class="sched-radio-card <?php echo e($oldSched === 'weekly' ? 'active' : ''); ?>" for="sched_weekly" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_weekly"
                               value="weekly" <?php echo e($oldSched === 'weekly' ? 'checked' : ''); ?>
                    ...
                    <label class="sched-radio-card <?php echo e($oldSched === 'specific' ? 'active' : ''); ?>" for="sched_specific" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_specific"
                               value="specific" <?php echo e($oldSched === 'specific' ? 'checked' : ''); ?>
                    ...
                    <label class="sched-radio-card <?php echo e($oldSched === 'open' ? 'active' : ''); ?>" for="sched_open" style="cursor:pointer;">
                        <input class="form-check-input me-2 mt-1" type="radio" name="schedule_type" id="sched_open"
                               value="open" <?php echo e($oldSched === 'open' ? 'checked' : ''); ?>
                ...
                <div id="sched_weekly_opts" class="schedule-opts mb-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-2">
                        <?php $__currentLoopData = $dayDefs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $isChecked = $oldSched === 'weekly' && in_array($idx, (array)$oldDays); ?>
                ...
                <div id="sched_specific_opts" class="schedule-opts mb-3" style="display:none;">
                    ...
                    <input type="hidden" name="specific_dates" id="specific_dates_hidden" value="<?php echo e(old('specific_dates')); ?>">
                ...
                <input type="hidden" name="available_dates" id="available_dates_hidden" value="<?php echo e(old('available_dates')); ?>">
        ...
        <div class="card shadow-sm border-0 rounded-3 mb-4">
            <div class="card-body">
                ...
                <div id="qaWrapper">
                    ...
                    ?>
                    <?php $__currentLoopData = $oldQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $oldQ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="input-group mb-2">
                            <span class="input-group-text bg-light" style="min-width:70px; font-size:12px;">Day <?php echo e($index + 1); ?></span>
                            <input type="text" name="question[]" class="form-control" placeholder="Day title (e.g. Departure from Delhi)" value="<?php echo e($oldQ); ?>">
                            <input type="text" name="answer[]" class="form-control" placeholder="Description" value="<?php echo e($oldAnswers[$index] ?? ''); ?>">
                            <?php if($index > 0): ?>
...
$('#category').change(function () {
    ...
    $.get('/admin/get-subcategories/' + id, function (data) {
        ...
        data.forEach(item => {
            const sel = '<?php echo e(old("subcategory_id")); ?>' == item.id ? 'selected' : '';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/admin/tours/create.blade.php ENDPATH**/ ?>