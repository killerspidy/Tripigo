<?php $__env->startSection('title', 'Add Subcategory'); ?>
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">Add Subcategory (Travel Type)</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('subcategories.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\travel update website\working\resources\views/admin/subcategories/create.blade.php ENDPATH**/ ?>