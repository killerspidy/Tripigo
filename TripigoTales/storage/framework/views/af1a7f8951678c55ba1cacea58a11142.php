 <!-- footer starts -->
    <footer class="pt-20 pb-4" style="background-image: url(<?php echo e(asset('images/background_pattern.png')); ?>)">
      <div class="section-shape top-0" style="background-image: url(<?php echo e(asset('images/shape8.png')); ?>)"></div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
       ...
       <li><a href="<?php echo e(route('frontend.faq')); ?>">FAQ's</a></li>
       ...
       <li><a href="<?php echo e(route('frontend.blogs')); ?>">Blogs</a></li>
                  ...
                  <li><a href="<?php echo e(route('frontend.terms.and.conditions')); ?>">Terms &amp; Conditions</a></li>
    ...
    <!-- footer ends --><?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>