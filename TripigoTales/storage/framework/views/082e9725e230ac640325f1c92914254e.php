        ...
        <div class="container">
            <div class="list-results d-flex align-items-center justify-content-between">
                <div class="list-results-sort">
                    <p class="m-0">Showing <?php echo e($tours->count()); ?> of <?php echo e($tours->count()); ?> results</p>
                </div>
                <div class="click-menu d-flex align-items-center justify-content-between">
                    <div class="sortby d-flex align-items-center justify-content-between ml-2">
                        <form method="get" action="<?php echo e(route('frontend.tour')); ?>" id="tourSortForm" class="d-inline">
                            <?php $searchParams = $searchParams ?? []; ?>
                            <?php if(!empty($searchParams['destination'])): ?><input type="hidden" name="destination" value="<?php echo e($searchParams['destination']); ?>"><?php endif; ?>
                            <?php if(!empty($searchParams['travel_type'])): ?><input type="hidden" name="travel_type" value="<?php echo e($searchParams['travel_type']); ?>"><?php endif; ?>
                            <?php if(!empty($searchParams['tour_duration'])): ?><input type="hidden" name="tour_duration" value="<?php echo e($searchParams['tour_duration']); ?>"><?php endif; ?>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img src="<?php echo e($tour->image ? asset($tour->image) : asset('/images/trending/trending10.jpg')); ?>" alt="image" class="" width="400" height="400">
    ...
    <div class="d-flex align-items-center justify-content-between flex-nowrap">
        ...
        <div class="d-flex align-items-center gap-2 ms-2">
            ...
            <div class="share-inline-btn d-flex align-items-center">
                ...
                <a href="https://wa.me/?text=<?php echo e(urlencode($tour->title)); ?> <?php echo e(url()->current()); ?>" target="_blank">
            ...
            <a href="<?php echo e(route('frontend.tour.detail', $tour->slug)); ?>" class="book-btn-inline">
                ...
                <div class="col-lg-12 py-5 text-center">
                    <p class="text-muted mb-3">No tours found. Try adjusting your search or <a href="<?php echo e(route('frontend.tour')); ?>">view all tours</a>.</p>
                    <a href="<?php echo e(url('/')); ?>" class="nir-btn">Back to Home</a>
                </div>
                <?php endif; ?>
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <a href="<?php echo e(route('frontend.tour')); ?>" class="nir-btn">View All Tours <i class="fa fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/tour.blade.php ENDPATH**/ ?>