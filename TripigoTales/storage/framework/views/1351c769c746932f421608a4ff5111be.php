...
<style>
    ...
    .auth-card {
        width: 100%;
        max-width: 480px; /* Slightly wider for the register form because of 2 cols */
    ...
    @media (max-width: 480px) {
        ...
        .row-mobile-gap > [class^="col-"]:last-child {
            margin-bottom: 0;
        }
    }
</style>
...
<div class="auth-section">
    <div class="auth-card">
        ...
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Join us and start your adventure today</p>
        </div>
        ...
        <form method="POST" action="/user/register">
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrapper">
                    <span class="auth-icon"><i class="far fa-user"></i></span>
                    <input
                        type="text"
                        name="name"
                        class="auth-input"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="auth-form-group mb-md-0">
                        <label class="auth-label">Confirm Password</label>
                        <div class="auth-input-wrapper">
                            <span class="auth-icon"><i class="fas fa-check-circle"></i></span>
                            <input
                                type="password"
        ...
        <p class="auth-footer">
            Already have an account? <a href="<?php echo e(route('frontend.login')); ?>">Sign In</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/register.blade.php ENDPATH**/ ?>