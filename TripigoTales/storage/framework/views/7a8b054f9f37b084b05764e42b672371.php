...
<div class="auth-section">
    <div class="auth-card">
        ...
        <?php if(session('error') === 'account_not_found'): ?>
            <div class="auth-alert-error" style="flex-direction:column; align-items:flex-start; gap:6px;">
                ...
                <div style="font-size:12.5px;">No account found for that email address. <a href="<?php echo e(route('frontend.register')); ?>" style="color:#ef4444; font-weight:700; text-decoration:underline;">Create an account</a> to get started.</div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/login.blade.php ENDPATH**/ ?>