...
<head>
    ...
    <title>Admin Login | Tripigo Tales</title>
    <!-- Custom CSS -->
...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:#f3f3f3;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="<?php echo e(asset('images/logo.png')); ?>" alt="logo" /></span>
...
</html><?php /**PATH C:\travel update website\working\resources\views/auth/login.blade.php ENDPATH**/ ?>