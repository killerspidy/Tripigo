                        ...
                        <tr>
                           ...
                           <td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('tours.edit',$tour->id)); ?>"
                                   class="btn btn-sm btn-info">
                                    Edit
                                </a>
                                <?php endif; ?>
                                <?php if(auth()->user()->can('delete tours')): ?>    
                                <form action="<?php echo e(route('tours.delete',$tour->id)); ?>"
                                      method="POST"
