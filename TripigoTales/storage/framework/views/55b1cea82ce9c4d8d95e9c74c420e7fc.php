        ...
        <div class="container">
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="bg-white rounded box-shadow overflow-hidden">
                                <div class="row g-0">
                                    <!-- Tour Image -->
                                    <div class="col-md-3">
                                        <?php if($booking->tour && $booking->tour->image): ?>
                                            <img src="<?php echo e(asset($booking->tour->image)); ?>" alt="<?php echo e($booking->tour->title ?? ''); ?>" class="w-100 h-100" style="object-fit: cover; min-height: 200px;">
                                        <?php else: ?>
                                    ...
                                    <div class="col-md-6 p-4">
                                        <div class="d-flex align-items-center mb-2">
                                            <h5 class="mb-0 me-3">
                                                <?php if($booking->tour): ?>
                                                    <a href="<?php echo e(route('frontend.tour.detail', $booking->tour->slug)); ?>"><?php echo e($booking->tour->title); ?></a>
                                                <?php else: ?>
                                        ...
                                        <?php if($booking->tour && $booking->tour->location): ?>
                                            <p class="mb-1 text-muted"><i class="icon-location-pin"></i> <?php echo e($booking->tour->location); ?></p>
                                        <?php endif; ?>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-sm-3 mb-2">
                                                ...
                                                <strong><?php echo e($booking->days ? $booking->days . ' ' . Str::plural('Day', $booking->days) : 'N/A'); ?></strong>
                                            </div>
                                            <div class="col-sm-3 mb-2">
                                                <small class="text-muted d-block">Persons</small>
                                                <strong><?php echo e($booking->persons); ?></strong>
                                            </div>
                                        </div>

                                        <div class="mt-2">
                                            <small class="text-muted">Booking ID: #<?php echo e($booking->id); ?></small>
                                            <small class="text-muted ms-3">Booked on: <?php echo e($booking->created_at->format('d M Y, h:i A')); ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 p-4 d-flex flex-column justify-content-center align-items-center border-start">
                                        <div class="text-center mb-3">
                                            ...
                                            <h4 class="theme mb-0">₹<?php echo e(number_format($booking->total_amount, 2)); ?></h4>
                                            <small class="text-muted">₹<?php echo e(number_format($booking->price_per_person, 2)); ?> x <?php echo e($booking->persons); ?> <?php echo e(Str::plural('person', $booking->persons)); ?></small>
                                        </div>

                                        <?php if($booking->status === 'paid'): ?>
                                            <a href="<?php echo e(route('frontend.booking.success', $booking->slug)); ?>" class="nir-btn w-100 text-center mb-2" style="font-size: 13px;">
                                                <i class="fa fa-eye"></i> View Details
                                            </a>
                                        <?php elseif($booking->status === 'pending'): ?>
                                            <button type="button" class="nir-btn w-100 mb-2 btn-retry-payment" 
                                                data-slug="<?php echo e($booking->slug); ?>" 
                                        ...
                                        <?php if($booking->canBeCancelled()): ?>
                                            <button type="button" class="btn btn-outline-danger w-100 btn-cancel-booking mb-2" 
                                                data-slug="<?php echo e($booking->slug); ?>" 
                                                data-policy="<?php echo e($booking->getRefundEligibilityText()); ?>"
                                        ...
                                        <?php if($booking->tour): ?>
                                            <a href="<?php echo e(route('frontend.tour.detail', $booking->tour->slug)); ?>" class="nir-btn-black w-100 text-center" style="font-size: 13px;">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(route('frontend.tour')); ?>" class="nir-btn">
...
$(document).ready(function() {
    ...
    function verifyPayment(paymentResponse, bookingId) {
        $.ajax({
            url: "<?php echo e(route('booking.razorpay.verify')); ?>",
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/myBookings.blade.php ENDPATH**/ ?>