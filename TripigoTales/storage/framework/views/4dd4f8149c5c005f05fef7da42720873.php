                            ...
                            <div id="contact-form1" class="contact-form">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form method="POST" action="<?php echo e(route('frontend.contact.submit')); ?>" name="contactform2" id="contactform2" class="no-prevent-default">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group mb-2">
                                                <input type="text" name="first_name" class="form-control" id="fullname" placeholder="First Name" value="<?php echo e(old('first_name')); ?>" required>
                                            </div>
                                            <div class="form-group mb-2">
                                                <input type="text" name="last_name" class="form-control" id="llastname" placeholder="Last Name" value="<?php echo e(old('last_name')); ?>" required>
                                            </div>
                                            <div class="form-group mb-2">
                                                <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo e(old('email')); ?>" required>
                                            </div>
                                            <div class="form-group mb-2">
                                                <input type="text" name="phone" class="form-control" id="phnumber" placeholder="Phone" value="<?php echo e(old('phone')); ?>" required>
                                            </div>
                                            <div class="textarea mb-2">
                                                <textarea name="message" placeholder="Enter a message" required><?php echo e(old('message')); ?></textarea>
                                            </div>
...
<?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/contactus.blade.php ENDPATH**/ ?>