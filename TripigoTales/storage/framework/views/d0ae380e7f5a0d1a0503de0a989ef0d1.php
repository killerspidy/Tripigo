...
<div class="container-fluid pb-5">
    ...
    <form method="POST" action="<?php echo e(route('tours.update', $tour->slug)); ?>"
                ...
                <div class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="title" class="form-control <?php echo e($errors->has('title') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('title', $tour->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="location" class="form-control <?php echo e($errors->has('location') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('location', $tour->location)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="language" class="form-control <?php echo e($errors->has('language') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('language', $tour->language)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="tour_duration" class="form-control <?php echo e($errors->has('tour_duration') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('tour_duration', $tour->tour_duration)); ?>" placeholder="e.g. 3 Days / 2 Nights">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="price" class="form-control <?php echo e($errors->has('price') ? 'is-invalid' : ''); ?>"
                                   value="<?php echo e(old('price', $tour->price)); ?>">
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="special_discount" class="form-control <?php echo e($errors->has('special_discount') ? 'is-invalid' : ''); ?>"
                                   value="<?php echo e(old('special_discount', $tour->special_discount ?? 0)); ?>" min="0" max="100">
                            <span class="input-group-text">%</span>
                        </div>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="status_discount" name="discount_status" value="1"
                                   <?php echo e(old('discount_status', $tour->discount_status) ? 'checked' : ''); ?>>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="max_people" class="form-control <?php echo e($errors->has('max_people') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('max_people', $tour->max_people)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="min_age" class="form-control <?php echo e($errors->has('min_age') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('min_age', $tour->min_age)); ?>" min="0" max="120">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="bedroom" class="form-control <?php echo e($errors->has('bedroom') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('bedroom', $tour->bedroom)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pickup" class="form-control <?php echo e($errors->has('pickup') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('pickup', $tour->pickup)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="4"
                                  ...
                                  ><?php echo e(old('description', $tour->description)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/admin/tours/edit.blade.php ENDPATH**/ ?>