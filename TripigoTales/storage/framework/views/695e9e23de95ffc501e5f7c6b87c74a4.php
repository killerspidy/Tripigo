...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zxx">
  <head>
   ...
   <title>Tripigo Tales | Tours & Travels | Customized Holiday Packages</title>
    ...
    <?php elseif(Route::is('frontend.tour')): ?>
        ...
        <meta name="author" content="Tripigo Tales" />
        <?php elseif(Route::is('frontend.tour.detail')): ?>
       <title>Tour Details | Domestic Tours – Tripigo Tales</title>
        ...
        <meta name="keywords" content="tour packages, holiday packages, domestic tours, travel packages india, customized tour packages" />
        <meta name="author" content="Tripigo Tales" />
     <?php elseif(Route::is('frontend.aboutus')): ?>
        ...
        <meta name="author" content="Tripigo Tales" />
          <?php elseif(Route::is('frontend.blogs')): ?>
        ...
        <meta name="author" content="Tripigo Tales" />
                          <?php elseif(Route::is('frontend.blog.detail')): ?>
    ...
    <?php elseif(Route::is('frontend.faq')): ?>
 <title>FAQs | Travel Booking Help – Tripigo Tales</title>
        ...
        <meta name="author" content="Tripigo Tales" />
    <?php elseif(Route::is('frontend.gallery')): ?>  
<title>Travel Gallery | Tripigo Tales Tours & Experiences</title>
        ...
        <meta name="author" content="Tripigo Tales" />
    <?php elseif(Route::is('frontend.contactus')): ?>
        ...
        <meta name="author" content="Tripigo Tales" />
       <?php elseif(Route::is('frontend.cancellation.policy')): ?>
       <title>Cancellation & Refund Policy | Tripigo Tales</title>
        ...
        <meta name="author" content="Tripigo Tales" />
      <?php elseif(Route::is('frontend.terms.and.conditions')): ?>
       <title>Terms & Conditions | Tripigo Tales Travel Services</title>
        ...
        <meta name="author" content="Tripigo Tales" />
         <?php elseif(Route::is('frontend.tour.book')): ?>
 <title>Travel Booking | Tripigo Tales</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
        <meta name="description" content="Find answers to common travel booking questions including payments, cancellations, tour packages, and customized trips at Tripigo Tales." />
        <meta name="keywords" content="travel faq, tour booking questions, holiday booking help, tripigo tales faq" />
        <meta name="author" content="Tripigo Tales" />
                 <?php elseif(Route::is('frontend.booking.success')): ?>
 <title>Booking Successful| Tripigo Tales</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
        <meta name="description" content="Find answers to common travel booking questions including payments, cancellations, tour packages, and customized trips at Tripigo Tales." />
        <meta name="keywords" content="travel faq, tour booking questions, holiday booking help, tripigo tales faq" />
        <meta name="author" content="Tripigo Tales" />
      <?php elseif(Route::is('frontend.privacy.policy')): ?>
...
.user-menu {
  ...
  <body>
            ...
            <div class="navbar-flex d-flex align-items-center justify-content-between w-100 pb-3 pt-3">
              ...
              <div class="navbar-collapse1 d-flex align-items-center" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" id="responsive-menu">
                  ...
                  <li class="<?php echo e(request()->routeIs('frontend.aboutus') ? 'active' : ''); ?>">
                  ...
                  <li class="<?php echo e(request()->routeIs('frontend.tour') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('frontend.tour')); ?>">Tours</a>
                  </li>

                  <li class="<?php echo e(request()->routeIs('frontend.gallery') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('frontend.gallery')); ?>">Gallery</a>
                  </li>
                  <li class="<?php echo e(request()->routeIs('frontend.contactus') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('frontend.contactus')); ?>">Contact Us</a>
                  </li>
                        ...
                        <div class="dropdown user-dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-end user-menu">
                              <div class="user-info text-center">
                                  ...
                                  <h6 class="mb-0 mt-2"><?php echo e($user->name); ?></h6>
                              </div>
                              <a class="dropdown-item" href="<?php echo e(route('frontend.profile.edit')); ?>">
                                  <i class="fa fa-user"></i> Profile Edit Details
                              </a>
                              <a class="dropdown-item" href="<?php echo e(route('frontend.my.bookings')); ?>">
                                  <i class="fa fa-suitcase"></i> My Bookings
                              </a>
                              <?php if(is_null($user->google_id)): ?>
                                  <a class="dropdown-item" href="<?php echo e(route('frontend.password.change')); ?>">
                                      <i class="fa fa-key"></i> Change Password
                                  </a>
                              <?php endif; ?>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item text-danger" href="<?php echo e(route('frontend.logout')); ?>">
                                  <i class="fa fa-sign-out-alt"></i> Logout
                              </a>
                          </div>
                      </div>
                    <?php else: ?>
                        <a href="<?php echo e(route('frontend.login')); ?>" class="nir-btn white">Login</a>
                    <?php endif; ?>
                </div>
              </div>
                        ...
                        <div class="dropdown user-dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-end user-menu">
                              <div class="user-info text-center p-2">
                                  <h6 class="mb-0" style="font-size: 0.9rem;"><?php echo e($user->name); ?></h6>
                              </div>
                              <a class="dropdown-item py-2" href="<?php echo e(route('frontend.profile.edit')); ?>" style="font-size: 0.8rem;">
                                  <i class="fa fa-user"></i> Profile
                              </a>
                              <a class="dropdown-item py-2" href="<?php echo e(route('frontend.my.bookings')); ?>" style="font-size: 0.8rem;">
                                  <i class="fa fa-suitcase"></i> My Bookings
                              </a>
                              <div class="dropdown-divider my-1"></div>
                              <a class="dropdown-item text-danger py-2" href="<?php echo e(route('frontend.logout')); ?>" style="font-size: 0.8rem;">
                                  <i class="fa fa-sign-out-alt"></i> Logout
                              </a>
                          </div>
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e(route('frontend.login')); ?>" class="btn btn-sm btn-primary border-0 px-3 py-2 rounded-pill shadow-sm text-white"><i class="fa fa-user me-1 text-white"></i> Login</a>
                    <?php endif; ?>
                </div>
    ...
    <!-- header ends -->
<?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>