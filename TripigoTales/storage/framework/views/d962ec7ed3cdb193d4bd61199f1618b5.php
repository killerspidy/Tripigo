...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> | Tripigo Tales</title>

    <!-- Custom CSS -->
    <link href="<?php echo e(asset('dist/css/style.min.css')); ?>" rel="stylesheet">
    <!-- Icons -->
    <link href="<?php echo e(asset('dist/css/icons/font-awesome/css/fontawesome-all.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('dist/css/icons/themify-icons/themify-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('dist/css/icons/iconmind/iconmind.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('dist/css/icons/simple-line-icons/css/simple-line-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('dist/css/icons/material-design-iconic-font/css/material-design-iconic-font.min.css')); ?>" rel="stylesheet">
...
<?php /**PATH C:\Omkar Dhamdhere\Tejas Project Frelance\TripigoTales\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>