<?php $__env->startSection('title', 'Categories (Destinations)'); ?>
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($cat->image): ?>
                                    <img src="<?php echo e(asset($cat->image)); ?>" width="50" height="50" style="object-fit: cover;">
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST"
                                      action="<?php echo e(route('categories.destroy', $cat)); ?>"
                                      class="d-inline"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\travel update website\working\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>